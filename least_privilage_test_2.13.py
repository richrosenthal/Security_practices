...
#So here's what I've been able to decipher. I have no idea how to read this code but I made a couple of changes
#in order for it work as intended.
import os
import stat
...
def grant_permission(name_list, filename):
    #here's the logic I added to make sure only admins get all privilages. the name list is probably not the best name, should be result or isadmin or something
    if name_list:
...
if __name__ == '__main__':
    ...
    with open(filename) as f:
        ...
        if result:
            ...
            user(filename, name)
    #this used to be (k, filename) but I changed it to result
